...
def plot_simple_cnn():
    arch = [
        ...
        to_Conv("uconv1", 16, 32, offset="(0,0,0)", to="(unpool1-east)", height=16, depth=16, width=2, caption="Uconv1"),
        
        to_UnPool("unpool2", offset="(2,0,0)", to="(uconv1-east)", width=1, height=32, depth=32, opacity=0.5, caption="Upsample"),
        to_Conv("uconv2", 32, 64, offset="(0,0,0)", to="(unpool2-east)", height=32, depth=32, width=2, caption="Uconv2"),
        
        to_UnPool("unpool3", offset="(2,0,0)", to="(uconv2-east)", width=1, height=48, depth=48, opacity=0.5, caption="Upsample"),
        to_Conv("uconv3", 64, 128, offset="(0,0,0)", to="(unpool3-east)", height=48, depth=48, width=2, caption="Uconv3"),
        
        to_UnPool("unpool4", offset="(2,0,0)", to="(uconv3-east)", width=1, height=56, depth=56, opacity=0.5, caption="Upsample"),
        to_Conv("uconv4", 128, 128, offset="(0,0,0)", to="(unpool4-east)", height=56, depth=56, width=2, caption="Uconv4"),
